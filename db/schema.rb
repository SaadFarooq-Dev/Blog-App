...
ActiveRecord::Schema.define(version: 2022_09_02_093129) do
  ...
  create_table "suggestion_replies", force: :cascade do |t|
    t.text "body"
    t.bigint "suggestion_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "user_id"
    t.index ["suggestion_id"], name: "index_suggestion_replies_on_suggestion_id"
    t.index ["user_id"], name: "index_suggestion_replies_on_user_id"
  end
  ...
  add_foreign_key "replies", "suggestions"
  add_foreign_key "replies", "users"
  add_foreign_key "reports", "users"
  add_foreign_key "suggestion_replies", "suggestions"
  add_foreign_key "suggestion_replies", "users"
